...
/**
 * hoare_partition - Starts hoare partition scheme
 * @array: Specifies array of integers to be sorted
 * @low: Specifies index in source array that begins partition
 * @high: Specifies index in source array that ends partition
 * @size: Specifies amount of elements in array
 * Return: The new index for  new recursive partition
 */
