...
/**
 *_calloc - Starts  a calloc function
 *@nmemb: Specifies number of elemets
 *@size: Specifies bit size of each element
 *Return: The pointer to memory assignement (Ends)
 */
...
/**
 * counting_sort - Starts counting sort method implementation
 * @array: Specifies array to sort
